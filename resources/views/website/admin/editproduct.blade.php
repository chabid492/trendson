              ...
              <div class="col-lg-12 mb-5">
                <div class="card">
                  ...
                  <div class="card-body">
                    ...
                    <form class="form-horizontal p-3" method="post" action="/updatepro/{{$result->id}}" enctype="multipart/form-data">
                      {{ csrf_field() }}
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-md-9">
                          <input type="text" name="desc" value="{{ $result->description }}" class="form-control"><small class="form-text text-muted ml-3">Write a short description about product.</small>
                        </div>
                      </div>
